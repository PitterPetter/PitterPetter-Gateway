...
public class JwtAuthorizationFilter implements GlobalFilter, Ordered { // filter 메서드
	...
	private static final List<String> PUBLIC_PATHS = List.of(
		...
		"/api/diaries/v3/api-docs/**",
		"/api/images/swagger-ui",
		"/api/images/swagger-ui/**",
		"/api/images/swagger-ui.html",
		"/api/images/swagger-ui.css",
		"/api/images/swagger-ui-bundle.js",
		"/api/images/swagger-ui-standalone-preset.js",
		"/api/images/swagger-initializer.js",
		"/api/images/index.css",
		"/api/images/favicon-32x32.png",
		"/api/images/favicon-16x16.png",
		"/api/images/v3/api-docs",
		"/api/images/v3/api-docs/**",
		...
		"/api/courses/swagger-ui.css",
		"/api/courses/swagger-ui-bundle.js",
		"/api/courses/swagger-ui-standalone-preset.js",
		"/api/courses/swagger-initializer.js",
		"/api/courses/index.css",
		"/api/courses/favicon-32x32.png",
		"/api/courses/favicon-16x16.png",
